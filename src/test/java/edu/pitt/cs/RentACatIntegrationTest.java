...
public class RentACatIntegrationTest {
	...
	public void testGetCatNullNumCats0() throws Exception{
		// TODO: Fill in
		RentACat emptyRentACat = RentACat.createInstance(InstanceType.IMPL);
		Method m = emptyRentACat.getClass().getDeclaredMethod("getCat", int.class);
    	m.setAccessible(true);
		Cat c = (Cat) 
		m.invoke(emptyRentACat, 2);
		assertNull(c);
